    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8" style={{ backgroundColor: '#F5F5F5' }}>
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sistema Bancário de Criptomoedas</p>
        </div>

        <div className="bg-white rounded-2xl shadow-xl p-8" style={{ borderTop: '4px solid #1E3A8A' }}>
          <h2 className="text-2xl font-semibold mb-6" style={{ color: '#1E3A8A' }}>Login</h2>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              Não tem uma conta?{' '}
              <Link to="/register" className="font-semibold hover:underline" style={{ color: '#1E3A8A' }} data-testid="login-register-link">
                Cadastre-se
              </Link>
            </p>
          </div>
